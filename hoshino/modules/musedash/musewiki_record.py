...
nekovc_folder = "C:/Resources/record/musewiki/角色语音/NEKO/游戏主播/触摸语音/"
yumevc_folder = "C:/Resources/record/musewiki/角色语音/柚梅/领航员/触摸语音/"
jkvc_folder = "C:/Resources/record/musewiki/角色语音/布若/制服少女/触摸语音/"
jokervc_folder = "C:/Resources/record/musewiki/角色语音/布若/华服小丑/触摸语音/"
pilot_folder = "C:/Resources/record/musewiki/角色语音/布若/飞行员/触摸语音/"
idol_folder = "C:/Resources/record/musewiki/角色语音/布若/偶像/触摸语音/"
zombie_folder = "C:/Resources/record/musewiki/角色语音/布若/僵尸少女/触摸语音/"
rockvc_folder = "C:/Resources/record/musewiki/角色语音/凛/贝斯手/触摸语音/"
workervc_folder = "C:/Resources/record/musewiki/角色语音/凛/打工战士/触摸语音/"
sleepyvc_folder ="C:/Resources/record/musewiki/角色语音/凛/梦游少女/触摸语音/"
santavc_folder = "C:/Resources/record/musewiki/角色语音/凛/圣诞礼物/触摸语音/"
bunnyvc_folder = "C:/Resources/record/musewiki/角色语音/凛/兔女郎/触摸语音/"
rampagevc_folder = "C:/Resources/record/musewiki/角色语音/凛/问题少女/触摸语音/"
blackvc_folder = "C:/Resources/record/musewiki/角色语音/玛莉嘉/黑衣少女/触摸语音/"
magicvc_folder = "C:/Resources/record/musewiki/角色语音/玛莉嘉/魔法少女/触摸语音/"
violinvc_folder = "C:/Resources/record/musewiki/角色语音/玛莉嘉/提琴少女/触摸语音/"
evilvc_folder = "C:/Resources/record/musewiki/角色语音/玛莉嘉/小恶魔/触摸语音/"
maidvc_folder = "C:/Resources/record/musewiki/角色语音/玛莉嘉/女仆/触摸语音/"

neko_hurt_folder = "C:/Resources/record/musewiki/角色语音/NEKO/通用受伤音效/"
yume_hurt_folder = "C:/Resources/record/musewiki/角色语音/柚梅/通用受伤音效/"
rin_hurt_folder = "C:/Resources/record/musewiki/角色语音/凛/通用受伤音效/"
buro_hurt_folder = "C:/Resources/record/musewiki/角色语音/布若/通用受伤音效/"
marija_hurt_folder = "C:/Resources/record/musewiki/角色语音/玛莉嘉/通用受伤音效/"
...
async def wiki_send_record(bot, ev: CQEvent):
    ...
    if input == "布若" or input == "buro" or input == "凛" or input == "rin" or input == "玛莉嘉" or input == "marija":  #联动角色NEKO和柚梅因为目前是唯一的，所以不做前缀判断，如果游戏后续出了新的角色皮肤，需要在此行进行修改。
        ...
        if input == "游戏主播NEKO#ФωФ" or input == "游戏主播neko" or input == "NEKO#ФωФ" or input == "neko":#联动目前唯一所以可直接匹配名称
            ...
            await bot.send(ev, f'[CQ:record,file=file:///{nekovc_folder}{filename}]')
        ...
        if input == "领航员柚梅" or input == "柚梅" or input == "yume":#联动目前唯一所以可直接匹配名称
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{yumevc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "制服少女布若" or input == "制服少女":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{jkvc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "华服小丑布若" or input == "华服小丑":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{jokervc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "飞行员布若" or input == "飞行员":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{pilot_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "偶像布若" or input == "偶像":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{idol_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "僵尸少女布若" or input == "僵尸少女":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{zombie_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "贝斯手凛" or input == "贝斯手":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{rockvc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "打工战士凛" or input == "打工战士":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{workervc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "梦游少女凛" or input == "梦游少女":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{sleepyvc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "圣诞礼物凛" or input == "圣诞礼物":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{santavc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "兔女郎凛" or input == "兔女郎":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{bunnyvc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "问题少女凛" or input == "问题少女":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{rampagevc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "黑衣少女玛莉嘉" or input == "黑衣少女":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{blackvc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "魔法少女玛莉嘉" or input == "魔法少女":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{magicvc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "提琴少女玛莉嘉" or input == "提琴少女":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{violinvc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "小恶魔玛莉嘉" or input == "小恶魔":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{evilvc_folder}{filename}]')
            await bot.send(ev,text)
            return
        if input == "女仆玛莉嘉" or input == "女仆":
            ...
            filename = random.choice(list(voice_data))
            text = voice_data[filename]
            await bot.send(ev, f'[CQ:record,file=file:///{maidvc_folder}{filename}]')
            await bot.send(ev,text)
            return

all_voice = [nekovc_folder,yumevc_folder,jkvc_folder,jokervc_folder,pilot_folder,idol_folder,zombie_folder,rockvc_folder,workervc_folder,sleepyvc_folder,santavc_folder,bunnyvc_folder,rampagevc_folder,blackvc_folder,magicvc_folder,violinvc_folder,evilvc_folder]

@sv.on_fullmatch(["随机角色语音"])
async def random_send_voice(bot, ev):
    ranvoice_folder = random.choice(all_voice)
    uid = ev['user_id']
    filelist = os.listdir(ranvoice_folder)
    path = None
    while not path or not os.path.isfile(path):
        filename = random.choice(filelist)
        path = os.path.join(ranvoice_folder, filename)
    if not _flmt.check(uid):
...
async def wiki_send_hurt(bot, ev: CQEvent):
    ...
    if not input:
        ...
        if input == "NEKO#ФωФ" or input == "neko":
            hurt_folder = neko_hurt_folder
            filelist = os.listdir(hurt_folder)
            path = None
            while not path or not os.path.isfile(path):
                filename = random.choice(filelist)
                path = os.path.join(hurt_folder, filename)
            try:
                await bot.send(ev, f'[CQ:record,file=file:///{path}]')
            except CQHttpError:
        ...
        if input == "玛莉嘉" or input == "marija":
            hurt_folder = marija_hurt_folder
            filelist = os.listdir(hurt_folder)
            path = None
            while not path or not os.path.isfile(path):
                filename = random.choice(filelist)
...
async def random_send_audioclip(bot, ev):
    audioclip_folder = "C:/Resources/record/musewiki/etc/"
    uid = ev['user_id']
...
async def random_send_faovr(bot, ev):
    faovr_folder = "C:/Resources/record/musewiki/favor/"
    uid = ev['user_id']
