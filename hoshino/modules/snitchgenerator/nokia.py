...
def generate_image(text: str):
    origin_im = Image.open("G:\qqbot\hoshino\modules\snitchgenerator\images")
    text = "".join(text)
    length = len(text)
    width, height = font.getsize(text)
    current_width = 0
    ...
    # origin_im.save("C:/Users/Administrator/HoshinoBot/hoshino/modules/snitchgenerator/results/final.png", "png") Save as local file
