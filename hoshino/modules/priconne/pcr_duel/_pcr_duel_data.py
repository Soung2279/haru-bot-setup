...
# =================================== #bangdream
    ...
    ####1700=======1720###=====
    1700:["比利·海灵顿","Billy Herrington'Big Ass","比利王","王♂","森の妖精"],
    1701:["木吉カズヤ","Danny_Resko","木吉和也"],
    1702:["贝奥兰迪","猎天使魔男","Biollante"],
    1703:["范·达克霍姆","Van Darkholme","暗之妖精","暗黑佟大为","佟dark为",],
    1704:["镰田吾作"],
    1705:["金阁","“金阁犬"],
    1706:["香蕉君","尻比","那个男人","象征着自由的男人",],
    1707:["城ノ内 悠二","城之内悠二","Blake Smith"],
    1708:["托塔斯藤冈"],
    1709:["畑山ベーコン","畑山培根"],
    1710:["银阁",],
...
# =================================== #Collection
    ...
    4639:["心语千夜","千夜","萝莉控"],
    4640:["卡布达","kabuda",],
    4641:["我家miku爱吃葱","屑开发者","憨憨","miku",],
    4642:["筒隐月子","魔理沙",],
    4643:["椎名なのは","铃心千音","千音",],
    4644:["大天使","dd头子","带天使",],
    4645:["8岁喷水小萝莉","miku女儿","xcw1",],
    4646:["emtel","e佬",],
    4647:["冬土拨鼠夏土豆","土拨鼠","中野","屑中野",],
    4648:["枫桦","神","枫佬",],
    4649:["mengx",],
    4650:["勿念苍穹","lsp","勿念",],
    4651:["夕阙","喜鹊",],
...
# =================================== #blhx
    ...
    6011: ['小天鹅','小天鹅a','小天鹅b'],
    6012: ['狐提','狐提a','狐提b'],
    6013: ['不知火(碧蓝航线)','不知火a','不知火b'],
    6014: ['Z20','Z20a','Z20b'],
    6015: ['Z21','Z21a','Z21b'],
    6016: ['睦月','睦月a','睦月b'],
    6017: ['如月','如月a','如月b'],
    6018: ['卯月(碧蓝航线)','卯月a','卯月b'],
    6019: ['水无月','水无月a','水无月b'],
    6020: ['三日月','三日月a','三日月b'],
    6021: ['杜威','杜威a','杜威b'],
 ...
 # =================================== #
    ...
    # =================================== #
    #恋×シンアイ彼女#
    7100: ['姫野星奏','星奏','HimenoSena','届不到'],
    7101: ['新堂彩音','彩音','ShindouAyane'],
    7102: ['小鞠结衣','ゆい','KomariYui'],
    7103: ['四條凛香','凛香','ShijouRinka'],
 ...
 #ノラと皇女と野良猫ハート#
    ...
    7502: ['帕特丽西亚','パトリシア','Patricia','帕特','帕特莉西亚'],
 ...
 #FGO#
    ...
    8002: ['阿尔托莉雅·潘德拉贡','阿尔托利亚','呆毛','棉被','吾王'],
    ...
    8136: ['伊莉雅丝菲尔·冯·爱因兹贝伦','小学生','伊利亚斯菲尔'],
 ...
 #ウマ娘 プリティーダービー#
    ...
    12000: ["犬山玉姬","犬山たまき","犬山哥","海苔男","巴别塔" ],
    12001: ["神乐mea","神楽めあ","mea","吊羊","卡古拉没牙","屑女人","神乐魅娅","田中庄司","吊人" ],
    12002: ["神楽七奈","狗妈" ],
    12003: ["宇森hinako","蝙蝠妹" ],
    12004: ["兔鞠mari" ],
    12005: ["天宫心","阿喵喵" ],
    12006: ["辉夜月","疯婆子" ],
    12007: ["咩栗","蜗牛姐姐","我被踢出去啦","糟透了","电击小羊" ],
    12008: ["猫宫日向","猫宫hinata","猫老大" ],
    12009: ["月之美兔","委员长","月ノ美兎","阿委","杂鱼","兔头" ],
    12010: ["夢乃栞","堕天使","Bantuber" ],    
    12011: ["七海菜菜美","Nana7mi","海子姐","七奶奶","773","大鲨鱼","鲨鱼人","柠檬鲨","厕所精灵" ],
    12012: ["物述有栖","alice" ],
    12013: ["呜米Umy","呜米","乌咪","呜咪","乌米","狼崽" ],
    12014: ["白雪深白","深白醬","ShirayukiMishiro" ],
    12015: ["堕天稚悠爱","悠爱" ],
    12016: ["白神遥","钢板","豹豹","海豹" ],
    12017: ["田中姬铃木雏" ],
    12018: ["ywwuyi","鸭子","乙方大佬","圣处男" ],
    12019: ["希亚娜","ciyana","小话痨","小笨比","希希","希宝" ],
    12020: ["笹木咲","嚣张熊猫人" ],
    12021: ["召唤师yami","yami" ],
    12022: ["花丸晴琉","橘子","花大嘴","花爷","Lisa丸" ],
    12023: ["有栖Mana","角龙","黑白角龙" ],
    12024: ["饼月ひまり" ],
    12025: ["泠鸢yousa","好鸟","渣鸟","冷鸟","急冻鸟","帝企鹅","口胡鸟","鸢大头","鸢宝","鸢二宝","元宝","没腿主播" ],
    12026: ["本间向日葵","傻葵","himawari" ],
    12027: ["樋口楓","でろーん","趴趴小枫","德龙" ],
    12028: ["早稻叽","恶魔","叽叽" ],
    12029: ["時雨羽衣","时雨妈妈" ],
    12030: ["沙月ちゃん","小沙月" ],
    12031: ["綾奈奈奈","粉兔子" ],
    12032: ["椎名唯華","椎名","しぃしぃ","西西","三下","大福","草莓大福","人渣" ],
    12033: ["夏诺雅","しゃのあ","Shanoa","绝壁","Neetuber","夏小姐" ],
    12034: ["風宮まつり","酒神" ],
    12035: ["Paryi","帕里","帕里妈妈","狗屎兔子","好人","原日本神一位" ],
    12036: ["爱宫Milk","milk" ],
    12037: ["凤玲天天","鳳玲天々","HoureiTenten","天天","王凤玲","傻天","天宝","天哥" ],
    12038: ["阿露丝·阿尔玛","阿露丝","アルス·アルマル","小福","圆圆","264","雨刮少女" ],
    12039: ["森永みう" ],
    12040: ["hanser","慈善赌王","憨八嘎","儿歌王","黑道千金" ],
    12041: ["星川莎拉","星川サラ","Hoshikawa Sara","盘子公主","星川" ],
    12042: ["喵田弥夜Miya","喵田弥夜","miya","方块喵","方块猫" ],
    12043: ["星宫汐","ほしみやしお","Hosimiya Sio","汐宝","汐酱","小汐" ],
    12044: ["早见咲","はやみさき","Hayami Saki","老大哥","真红眼白龙","faki" ],
    12045: ["铃宫铃","Suzumiya Rin","0g0","0宝" ],
    12046: ["花谱","KAF","かふ" ],
    12047: ["钉宫妮妮","釘宮ににこ","Kugimiya Ninico","独角猫","妮妮子","妮妮" ],
    12048: ["烤鱼子","烤鱼" ],
    12049: ["电脑少女siro","siro","小白" ],
    12050: ["莉泽·赫露艾斯塔","理是地獄絵巣太","第二工场长" ],
    12051: ["姬咲柚流" ],
    12052: ["古守血游","こもりちゆ","Komori Chiyu","chiyu","kimori","打工人","古守","古守小姐" ],
    12053: ["白桃Shirako","白桃","毛毛" ],
    12054: ["琴吹梦","琴吹ゆめ","Kotobuki Yume","肥梦" ],
    12055: ["爱尾美铃","愛尾みすず","Manao Misuzu","咪酱" ],
    12056: ["天羽四叶","天羽よつは","Amahane Yotsuha","428","柚子哈" ],
    12057: ["雫るる","雫Lulu","Shizuku Lulu","lulu","露露" ],
    12058: ["阳向心美","阳向ここみ","Hinata Cocomi","ccm","ddm","菜菜米" ],
    12059: ["美波七海","美波Nami","Minami Nami","373","BL大将军","没波七海" ],
    12060: ["天使nano","天使なの","Tenshi Nano" ],
    12061: ["Hiiro","粉猫","希萝","女爸爸","三文鱼女皇","hrrio","耳朵" ],
    12062: ["名取さな" ],
    12063: ["乙女音","音","oto","oto酱" ],
    12064: ["御伽原江良","gibara","猴子" ],
    12065: ["花园Serena","花園セレナ","Hanazono Serena","花园猫","橙猫","猫猫" ],
    12067: ["阿梓","阿梓从小就很可爱","梓哥" ],
    12068: ["织田信姬","信姬" ],
    12069: ["龙胆尊","尊妈" ],
    12070: ["高槻律","高太尉" ],
    12071: ["郡道美玲","郡道" ],
    ...
    12099: ["绯赤艾莉欧","红团长" ],
    12100: ["菜菜子" ],
    12103: ["凑阿库娅", "みなとあくあ", "湊あくあ", "阿库娅", "aqua", "阿夸", "夸哥", "夸神", "海王", "洋葱精", "山田赫敏", "山田·赫敏", "大亏哥", "桐谷夸人", "洋葱", "洋葱头" ],
    # ===================================私心 #
    #12101: ["百鬼绫目", "百鬼あやめ", "狗狗", "绫目", "ayame" ],
    #12102: ["角卷绵芽", "角巻わため", "毛球", "羊", "顶顶羊", "咚咚羊", "畜生羊", "木口锤石", "WTM" ],
    #12103: ["凑阿库娅", "みなとあくあ", "湊あくあ", "阿库娅", "aqua", "阿夸", "夸哥", "夸神", "海王", "洋葱精", "山田赫敏", "山田·赫敏", "大亏哥", "桐谷夸人", "洋葱", "洋葱头" ],
    #12104: ["愈月巧可", "癒月ちょこ", "巧可老师", "巧可" ],
    #12105: ["戌神沁音", "戌神ころね", "沁音", "吼啦迷迭吼啦哟", "面包狗","外神" ],
    #12106: ["润羽露西娅", "潤羽るしあ", "露西娅",  "死灵魔法师", "死灵使", "绿粽子", "粽子", "三亚王", "露西娅妈妈", "狂爆粽子", "润羽露西法", "粽哥", "阿马粽", "砧板" ],
    #12107: ["猫又小粥", "猫又おかゆ", "小粥", "阿汤", "汤哥", "饭团猫", "阿汤哥", "大脸猫" ]
...
##   角色范围表    ###
###   1000--1150   1155--1805  1907--1920  PCR角色包

###   1523--1543                           柚子(yozi)角色包

###   1601--1635                           邦邦手游角色包

###   1700--1720                           哲学角色包

###   3001--3054                           MILLION LIVE角色包

###   4001--4639                           舰队collection角色包

###   5001--5179                           明日方舟手游角色包

###   6000--6506                           碧蓝航线手游角色包1-5

###   7001--7019                           原神角色包

###   7100--7104                           恋×シンアイ彼女角色包

###   7200--7304                           桜ひとひら恋もよう角色包

###   7300--7307                           Clover Days角色包

###   7400--7476                           雀魂角色包

###   7500--7510                           ノラと皇女と野良猫ハート角色包

###   8001--8300                            FGO手游角色包

###   11100--11175                          ウマ娘 プリティーダービー角色包

###   12000--12108                          虚拟vtb角色包 
